...
[ContractAttribute(
    "OfferingStartOptions",
    Version = "1.0",
    Namespace = "Framework.Offering")]
public class OfferingStartOptions
{
    ...
    public Dictionary<string, string> DockerLabels { get; set; } = new();

    public List<int> ExposedPorts { get; set; } = new();

    public List<string> AllowedImageRegistries { get; set; } = new();
}

...
internal abstract class TransportClientGenerator
{
    ...
    protected TransportClientGenerator(INamedTypeSymbol iface, string classSuffix)
    {
        Iface = iface;
    ...
    protected Sequence ClientMethods() => Sequence.Lines(OrdinaryMethods.Select(ClientMethodEmitter.Emit));
}
